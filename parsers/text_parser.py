...
#       headings and contextual blocks for high-fidelity retrieval.
#
##
# Development date    Developed by       Comments
# ----------------    ------------       ---------
# 14/11/2024          Saddam Khan        Initial implementation
# 18/12/2024          Saddam Khan        Added markdown and plain-text sliding window chunking
#
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
class TextParser(BaseParser):
    ...
    def parse_text(self, content: str, filename: str, **kwargs) -> List[DocumentChunk]:
        ...
        elif "runbook" in lower_name or "devops" in lower_name or "engineer" in lower_name:
            allowed_roles = ["engineering", "all"]

        # If Markdown, split on H1/H2 headings
