...
#       Transforms structured tabular records into semantically rich markdown representations.
#
##
# Development date    Developed by       Comments
# ----------------    ------------       ---------
# 14/11/2024          Saddam Khan        Initial implementation
# 18/12/2024          Saddam Khan        Added tabular row-group serialization and header retention
#
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
class CSVParser(BaseParser):
    ...
    :param rows_per_chunk <int>: Number of tabular data rows per document chunk.
    :return CSVParser: Configured parser instance.
    """
    ...
    def parse_text(self, content: str, filename: str, **kwargs) -> List[DocumentChunk]:
        """
        Explanation:
            Parses raw CSV/TSV string content into structured markdown table chunks.

        :param content <str>: Raw CSV or TSV file text content.
        :param filename <str>: Source file name or GCS path.
